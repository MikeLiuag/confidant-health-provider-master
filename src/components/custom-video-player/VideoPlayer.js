...
import {Text, Image,ActivityIndicator, ImageBackground, Platform, StyleSheet, TouchableOpacity, View, ViewPropTypes } from 'react-native';
import Icon from 'react-native-vector-icons/MaterialIcons';
import Video from 'react-native-video';
import {addTestID} from "ch-mobile-shared"; // eslint-disable-line
        ...
        return (
            <View style={[styles.controls, customStyles.controls]}>
                ...
                {this.props.muted ? null : (
                    <TouchableOpacity
                        {...addTestID('on-mute-press')}
                        onPress={this.onMutePress} style={customStyles.controlButton}>
                        <Icon
                ...
                {(Platform.OS === 'android' || this.props.disableFullscreen) ? null : (
                    <TouchableOpacity
                        {...addTestID('on-toggle-full-screen')}
                        onPress={this.onToggleFullScreen} style={customStyles.controlButton}>
                        <Icon
                            style={[styles.extraControl, customStyles.controlIcon]}
                            name="fullscreen"
                            size={32}
